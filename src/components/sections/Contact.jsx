...
export const Contact = () => {
    ...
    return(
        <section id="contact" className="min-h-screen flex items-center justify-center py-20">
            <div className="w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto px-4">
            <RevealOnScroll>
                <div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            ...
                            className="w-full bg-white/15 border border-white/10 
                        ...
                        <div className="relative">
                            <textarea name="message" id="message" required value={formData.message} rows={5}
                            className="w-full bg-white/15 border border-white/10 
                            rounded px-4 py-3 text-white transition focus:outline-none 
                            focus:border-blue-500 focus:bg-blue-500/5"
                        ...
                        text-white py-3 px-6 rounded font-medium transition 
